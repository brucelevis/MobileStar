#ifndef __LOBBY_FRIEND_LAYER_H__
#define __LOBBY_FRIEND_LAYER_H__
...
class LobbyFriendLayer : public cocos2d::Layer
{
public:
    virtual bool init();
/*
...
#endif //__LOBBY_FRIEND_LAYER_H__
