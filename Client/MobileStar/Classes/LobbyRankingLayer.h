#ifndef __LOBBY_RANKING_LAYER_H__
#define __LOBBY_RANKING_LAYER_H__
...
class LobbyRankingLayer : public cocos2d::Layer
{
public:
    virtual bool init();
/*
...
#endif //__LOBBY_RANKING_LAYER_H__
