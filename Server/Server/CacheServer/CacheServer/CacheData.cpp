...
#else
const char* LOG_NAME = "/Users/kimyongchan/MobileStar/Server/Server/CacheServer/CacheServer/connect_info.xml";
#endif
...
bool CacheData::LoadNetworkInfo()
{
...
const NetworkInfo* CacheData::getNetworkInfo(int serverModule)
{
